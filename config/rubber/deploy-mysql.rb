      ...
      master_instances.each do |ic|
        ...
        task task_name, :hosts => ic.full_name do
          ...
          if exists.strip.size == 0
            ...
            # FIXME(ja): removing all grants for blank user at any host
            # due to error with mysql permissions...
            # https://groups.google.com/forum/?fromgroups#!topic/rubber-ec2/Pnw1N4K7KOQ
